                            ...
                            return (
                                <div className='w-full p-4 shadow-lg flex flex-col justify-center items-center' key={i}>
                                    ...
                                    {o?.name === "General" ?
                                        ...
                                        <Link href={`/doctors?hospital_id=${id}&&department_id=${o.id}&&general=true`} className='w-full bg-transparent text-center hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded'>
                                            Consult Now
                                        </Link>
